        ...
        #for i in range (NUM_IMAGES):
            ...
            try:
                ...
                if image_result.IsIncomplete():
                    ...
                    # Figure (1) is default so you can omit this line. Figure (0) will create new window every time program hits this line
